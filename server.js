...
app.get('/home/pick_color', function(req, res) {
    ...
    var color_message = "SELECT color_msg FROM favorite_colors WHERE name = '" + color_choice + "';";
...
app.get('/team_stats', function(req, res) {
	var games2018 = "select * from football_games where game_date between '2019-01-01' and '2019-12-31';";
	var wins2018 = "select count(*) from football_games where game_date between '2019-01-01' and '2019-12-31' and	home_score > visitor_score;";
	var losses2018 = "select count(*) from football_games where game_date between '2019-01-01' and '2019-12-31' and home_score < 	visitor_score;";
db.task('get-everything', task => {
	return task.batch([
	task.any(games2018),
	task.any(wins2018),
...
app.get('/player_info', function(req, res) {
	var playerIDandName = 'select id, name from football_players;';
	db.task('get-everything', task => {
		return task.batch([
	task.any(playerIDandName)
]);
}).then(info => {
